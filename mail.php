...
$require = array('お名前','フリガナ','メールアドレス','電話番号','普通免許の有無','一種免許の取得日','国籍');
...
──────────────────────
リンケージ株式会社
〒810-0802 福岡市博多区中洲中島町4-23-1002
TEL：092-292-7088 　FAX：092-292-7022
E-mail:fukuoka@linkages.jp
URL: 
──────────────────────
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://linkages.jp/" target="_blank">- リンケージ -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
